...
<head>
  ...
  <?php include '../assets/header_files.php'; ?>
</head>
...
<body>
  ...
  <center>
    <a href="<?php echo DOMAIN; ?>/app/"><i class="fa fa-lock text-success"></i> Admin Login</a>
  </center>
  <?php include '../include/app/footer.php'; ?>
  <?php include '../assets/footer_files.php'; ?>
